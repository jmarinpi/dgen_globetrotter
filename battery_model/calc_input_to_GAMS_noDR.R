...
for (i4 in 1:length(vB2)){
  
# --- Defining Model Inputs: -------------------------------------
B_hr_storage = vB2[i4];     # number of hours of storage
...
filenm="C:/Users/edrury/Dropbox/AA_OPTIMIZATION/GAMS_battery/LOAD_DATA/MODEL_RUN_PARAMETERS_wDR.dat";
...
# call the GAMS model
a=system("gams battery_optimize_W_DR2_eSalesZero.gms -nocr=1");
#a=system("gams battery_optimize_W_DR2_eSalesAvg.gms -nocr=1");

# remove wonky GAMS directories
unlink("225*", recursive = TRUE);


t1=proc.time();

folder1=("C:/Users/edrury/Dropbox/AA_OPTIMIZATION/GAMS_battery/");
#folder2=("C:/Users/edrury/Dropbox/AA_OPTIMIZATION/GAMS_battery/RUNS/RUNS_B80eff_EsoldAvg/");
folder2=("C:/Users/edrury/Dropbox/AA_OPTIMIZATION/GAMS_battery/RUNS/RUNS_B80eff_EsoldZero/");
