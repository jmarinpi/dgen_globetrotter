...
filenm = 'C:/GamsProject_CG/Replicate/Lifetime/SOC_Year.csv';
lft_year = read.csv(filenm, header = TRUE) 
lft_year = lft_year[1,1]
...
first_year_cash = sum(NPV$batt_value) - Bcost * optBatSize * ann_CRF;
# number of years: lt_year
# need to calculate NPV then
