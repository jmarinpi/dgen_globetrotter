...
CREATE INDEX missing_ij_icf_com_points_the_geom_900914_gist ON diffusion_wind_data.missing_ij_icf_com_points using gist(the_geom_900914);
...
ALTER TABLE diffusion_wind.ij_cfbin_lookup_com_pts_us ALTER i TYPE integer;
ALTER TABLE diffusion_wind.ij_cfbin_lookup_com_pts_us ALTER j TYPE integer;
ALTER TABLE diffusion_wind.ij_cfbin_lookup_com_pts_us ALTER cf_bin TYPE integer;
-- add indices
