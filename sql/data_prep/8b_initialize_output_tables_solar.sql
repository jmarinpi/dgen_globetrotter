...
-- residential
DROP TABLE IF EXISTS diffusion_solar.outputs_res CASCADE;
...
-- commercial
DROP TABLE IF EXISTS diffusion_solar.outputs_com CASCADE;
...
-- industrial
DROP TABLE IF EXISTS diffusion_solar.outputs_ind CASCADE;
