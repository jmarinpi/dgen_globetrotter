...
DROP TABLE IF EXISTS diffusion_shared.pt_rate_isect_lkup_com;
CREATE TABLE diffusion_shared.pt_rate_isect_lkup_com
(
	pt_gid integer,
...
SELECT parsel_2('dav-gis','mgleason','mgleason',
		...
		'diffusion_shared.pt_rate_isect_lkup_com', 'a',22);
...
CREATE TABLE diffusion_shared.pt_rate_isect_lkup_ind
(
	pt_gid integer,
	state_abbr character varying(2),
	rate_id_alias integer
...
SELECT parsel_2('dav-gis','mgleason','mgleason',
		...
		INNER JOIN diffusion_shared.county_geom c
		ON a.county_id = c.county_id;',
		'diffusion_shared.pt_rate_isect_lkup_ind', 'a', 22);
...
CREATE TABLE diffusion_shared.pt_rate_isect_lkup_res
(
	pt_gid integer,
	state_abbr character varying(2),
	rate_id_alias integer
