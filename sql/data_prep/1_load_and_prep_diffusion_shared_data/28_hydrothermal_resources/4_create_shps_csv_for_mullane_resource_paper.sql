...
create view diffusion_geo.resources_hydrothermal as 
	(
		...
		gis_res_area_km2 as gis_reservoir_area_km2,
		orig_res_area_km2 as original_reservoir_area_km2,
		area_per_well_km2,
		n_wells as number_of_wells,
		accessible_resource_base_1e18_joules,
		mean_resource_1e18_joules,
		beneficial_heat_1e18_joules,
		beneficial_heat_mwh_30yrs,
		reference,
		notes
...
create view diffusion_geo.resources_hydrothermal_shp as 
	(
		...
		gis_res_area_km2 as giskm2,
		orig_res_area_km2 as origkm2,
		area_per_well_km2 as wellkm2,
		n_wells,
		accessible_resource_base_1e18_joules as accresbase,
		mean_resource_1e18_joules as meanres,
		beneficial_heat_1e18_joules as benheat,
		beneficial_heat_mwh_30yrs as benheatmwh,
		reference,
...
pgsql2shp -g the_geom_4326 -f /Users/mmooney/Dropbox/Projects/2016_01_27_dGeo/Documents/resources/Data/Output/Data_Share/US_Low_Temp_Data_Export/062816/us_low_temp_hydro_pt_062816.shp -h gispgdb -u mmooney -P mmooney dav-gis "select * from diffusion_geo.resources_hydrothermal_shp where sys_type = 'isolated system'";
