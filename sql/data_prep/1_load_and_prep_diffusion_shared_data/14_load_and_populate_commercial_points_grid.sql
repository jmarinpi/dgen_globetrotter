...
CREATE INDEX pt_grid_us_com_hdf_load_index
ON diffusion_shared.pt_grid_us_com
...
DROP TABLE IF EXISTS  diffusion_solar_data.pt_grid_us_com_missing_hdf_load_lookup;
CREATE TABLE  diffusion_solar_data.pt_grid_us_com_missing_hdf_load_lookup AS
with a AS
(
	select gid, the_geom_900914
	FROM diffusion_shared.pt_grid_us_com
...
FROM  diffusion_solar_data.pt_grid_us_com_missing_hdf_load_lookup b
where a.gid = b.gid
