...
plot(ve)
var(df2000$t)
# no trned in this dataset -- sill is about equal to the global variance of the dataset
...
# there still is a relationship...
# how strong
m = lm(t ~ depth_m, data = df1500)
summary(m) # fairly weak -- about 0.2
...
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 9.274  15.700  17.330  16.290  17.440  20.560 
