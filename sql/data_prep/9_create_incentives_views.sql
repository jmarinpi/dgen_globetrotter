...
CREATE TABLE diffusion_wind.incentives AS 
         SELECT uid, incentive_id, 
            ...
            wind_increment_3_capacity_kw AS increment_3_capacity_kw, 
            NULL::NUMERIC as increment_4_capacity_kw,
            wind_pbi_fit_duration_years AS pbi_fit_duration_years, 
            wind_pbi_fit_end_date AS pbi_fit_end_date, 
            wind_pbi_fit_min_output_kwh_yr AS pbi_fit_min_output_kwh_yr, 
            NULL::NUMERIC AS pbi_fit_max_size_for_dlrs_calc_kw,
            wind_ptc_duration_years AS ptc_duration_years, 
            wind_ptc_end_date AS ptc_end_date, 
            wind_rating_basis_ac_dc AS rating_basis_ac_dc, 
            wind_res_fit_dlrs_kwh AS fit_dlrs_kwh, 
            wind_res_pbi_dlrs_kwh AS pbi_dlrs_kwh, 
            COALESCE(wind_res_fit_dlrs_kwh, 0::numeric) + COALESCE(wind_res_pbi_dlrs_kwh, 0::numeric) AS pbi_fit_dlrs_kwh, 
            wind_res_increment_1_rebate_dlrs_kw AS increment_1_rebate_dlrs_kw, 
            wind_res_increment_2_rebate_dlrs_kw AS increment_2_rebate_dlrs_kw, 
            NULL::numeric AS increment_3_rebate_dlrs_kw, 
            NULL::NUMERIC AS increment_4_rebate_dlrs_kw,
            wind_res_max_dlrs_yr AS max_dlrs_yr, 
            wind_res_max_tax_credit_dlrs AS max_tax_credit_dlrs, 
            NULL::NUMERIC AS tax_credit_dlrs_kw,
            wind_res_max_tax_deduction_dlrs AS max_tax_deduction_dlrs, 
            wind_res_pbi_fit_max_dlrs AS pbi_fit_max_dlrs, 
            wind_res_pbi_fit_pcnt_cost_max AS pbi_fit_pcnt_cost_max,
            wind_pbi_fit_max_size_kw_ AS pbi_fit_max_size_kw,         
            wind_pbi_fit_min_size_kw AS pbi_fit_min_size_kw,              
            wind_res_ptc_dlrs_kwh AS ptc_dlrs_kwh, 
            wind_res_rebate_dlrs_kw AS rebate_dlrs_kw, 
            wind_res_rebate_max_dlrs AS rebate_max_dlrs, 
            wind_res_rebate_max_size_kw AS rebate_max_size_kw, 
            wind_res_rebate_min_size_kw AS rebate_min_size_kw, 
            wind_res_rebate_pcnt_cost_max AS rebate_pcnt_cost_max, 
            wind_res_tax_credit_pcnt_cost AS tax_credit_pcnt_cost, 
...
UNION ALL 
         SELECT uid, incentive_id, 
            ...
            wind_ptc_end_date AS ptc_end_date, 
            wind_rating_basis_ac_dc AS rating_basis_ac_dc, 
            wind_com_fit_dlrs_kwh AS fit_dlrs_kwh, 
            wind_com_pbi_dlrs_kwh AS pbi_dlrs_kwh, 
            COALESCE(wind_com_fit_dlrs_kwh, 0::numeric) + COALESCE(wind_com_pbi_dlrs_kwh, 0::numeric) AS pbi_fit_dlrs_kwh, 
            wind_com_increment_1_rebate_dlrs_kw AS increment_1_rebate_dlrs_kw, 
            wind_com_increment_2_rebate_dlrs_kw AS increment_2_rebate_dlrs_kw, 
            wind_com_increment_2_rebate_dlrs_kw AS increment_3_rebate_dlrs_kw, 
            NULL::NUMERIC AS increment_4_rebate_dlrs_kw,
            wind_com_max_dlrs_yr AS max_dlrs_yr, 
            wind_com_max_tax_credit_dlrs AS max_tax_credit_dlrs, 
            NULL::NUMERIC AS tax_credit_dlrs_kw,
            wind_com_max_tax_deduction_dlrs AS max_tax_deduction_dlrs, 
            wind_com_pbi_fit_max_dlrs AS pbi_fit_max_dlrs, 
            wind_com_pbi_fit_pcnt_cost_max AS pbi_fit_pcnt_cost_max, 
            wind_pbi_fit_max_size_kw_ AS pbi_fit_max_size_kw,         
            wind_pbi_fit_min_size_kw AS pbi_fit_min_size_kw,             
            wind_com_ptc_dlrs_kwh AS ptc_dlrs_kwh, 
            wind_com_rebate_dlrs_kw AS rebate_dlrs_kw, 
            wind_com_rebate_max_dlrs AS rebate_max_dlrs, 
            wind_com_rebate_max_size_kw AS rebate_max_size_kw, 
            wind_com_rebate_min_size_kw AS rebate_min_size_kw, 
            wind_com_rebate_pcnt_cost_max AS rebate_pcnt_cost_max, 
            wind_com_tax_credit_pcnt_cost AS tax_credit_pcnt_cost, 
