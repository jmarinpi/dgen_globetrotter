...
DROP TABLE IF EXISTS dg_wind.hsip_and_navteq_commercial_pts_conus_pop_ratio_nightday;
CREATE TABLE dg_wind.hsip_and_navteq_commercial_pts_conus_pop_ratio_nightday (
	gid integer,
	...
	SELECT parsel_2('dav-gis','dg_wind.hsip_and_navteq_commercial_pts','gid',
			'SELECT a.gid, ST_Value(b.rast,a.the_geom_4326) as pop_ratio_daynight
			FROM  dg_wind.hsip_and_navteq_commercial_pts a
		...
		'dg_wind.hsip_and_navteq_commercial_pts_conus_pop_ratio_nightday', 'a',16);
