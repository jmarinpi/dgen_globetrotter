...
CREATE OR REPLACE VIEW wind_ds.pt_grid_us_res_sample_view AS
...
SET LOCAL SEED TO 1;
CREATE OR REPLACE VIEW wind_ds.pt_grid_us_res_sample_load_view AS
...
SELECT a.gid, a.row_number, b.ann_cons_kwh, b.prob, b.weight,
...
FROM wind_ds.pt_grid_us_res_sample_view a
...
-- test run time
SET SEED to 1;
CREATE TABLE wind_ds.view_test as
SELECT *
FROM wind_ds.pt_grid_us_res_sample_load_view
