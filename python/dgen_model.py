           ...
           # set tech_mode
            ...
            if scenario_settings.tech_mode == 'elec':    
                ...
                for year in scenario_settings.model_years:
                    ...
                    agents = AgentsAlgorithm(agents, agent_mutation_geo.identify_bass_deployable_agents, (sunk_costs, )).compute()                                 
                    ...
                    agents = AgentsAlgorithm(agents, agent_mutation_geo.apply_tech_costs_baseline, (tech_costs_baseline_df, sunk_costs)).compute()                  
