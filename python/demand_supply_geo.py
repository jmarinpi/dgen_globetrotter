...
def calc_plant_lcoe(resources_with_costs_df, plant_depreciation_df, plant_construction_finance_factor):
    ...
    resources_with_costs_df['lcoe_dlrs_mwh'] = (((resources_with_costs_df['CRF'] * resources_with_costs_df['PFF'] * resources_with_costs_df['CFF'] * (resources_with_costs_df['OCC'] * 1 + resources_with_costs_df['GCC']) + resources_with_costs_df['FOM'])/(resources_with_costs_df['total_consumable_energy_per_wellset_mwh'])))# LCOE 2014$/MWh
