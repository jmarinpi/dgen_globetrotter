...
class Agents(object):
    ...
    def on_frame(self, func, func_args=None, in_place=True, **kwargs):
        ...
        results_df = self.run_with_runtime_tests(how_to_apply='on_frame', func=func, func_args=func_args, **kwargs)
    ...
    def run_with_runtime_tests(self, how_to_apply, func, func_args=None, cores=config.LOCAL_CORES, **kwargs):
        """
    ...
    def apply_on_row(self, func, cores=1, **kwargs):
        """
    ...
    def apply_chunk_on_row(self, func, cores=1, **kwargs):
        """
