...
def bill_calculator(load_profile, tariff, export_tariff):
    ...
    if hasattr(tariff, 'd_tou_8760'):
        ...
        period_matrix[range(n_timesteps),tariff.d_tou_8760+month_index*d_tou_n] = True
    ...
    if hasattr(tariff, 'e_tou_8760'):
        ...
        if export_tariff.full_retail_nem == False:
            ...
            e_period_import_matrix[range(len(tariff.e_tou_8760)),tariff.e_tou_8760+month_index*e_n] = True
        ...
        # Calculate energy charges with full retail NEM 
            ...
            e_period_matrix[range(len(tariff.e_tou_8760)),tariff.e_tou_8760+month_index*e_n] = True
