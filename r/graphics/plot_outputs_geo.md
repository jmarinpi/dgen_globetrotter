...
if(tech=='ghp') {
  ...
  ggsave_hack(sprintf('%s/total_capacity.png', ppt_dir), g, dpi = 600, height = 5, width = 8, units = 'in' )
  grid.newpage()
  
  grid.draw(out$national_num_of_adopters_bar)
  g = arrangeGrob(out$national_num_of_adopters_bar)
  ggsave_hack(sprintf('%s/total_adopters.png', ppt_dir), g, dpi = 600, height = 5, width = 8, units = 'in' )
  grid.newpage()
  
  grid.draw(out$national_market_cap_bar)
  g = arrangeGrob(out$national_market_cap_bar)
  ggsave_hack(sprintf('%s/total_market.png', ppt_dir), g, dpi = 600, height = 5, width = 8, units = 'in' )
  grid.newpage()
  
  # grid.draw(out$national_generation_bar)
  # g = arrangeGrob(out$national_generation_bar)
  # ggsave_hack(sprintf('%s/total_generation.png', ppt_dir), g, dpi = 600, height = 5, width = 8, units = 'in' )
  # grid.newpage()
  ...
  grid.draw(out$national_adopters_trends_bar)
  ggsave_hack(sprintf('%s/mms_and_ms.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
  # national_installed_capacity_by_system_size_bar(df,tech)
  # ggsave_hack(sprintf('%s/cumulative_capacity_by_system_size.png', ppt_dir), dpi = 600, height = 5, width = 8, units='in' )
} else if(tech=='du') {
...
ggsave_hack(sprintf('%s/payback_and_mbs.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
...
# ggsave_hack(sprintf('%s/lcoe_contour.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )

# lcoe_boxplot(df)
# ggsave_hack(sprintf('%s/lcoe_boxplot.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
# lcoe_cdf(df, start_year, end_year)
# ggsave_hack(sprintf('%s/lcoe_cdf.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
...
out$plot
ggsave_hack(sprintf('%s/leasing_market_share.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
...
ggsave_hack(sprintf('%s/cumulative_capacity_by_business_model.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
...
#   ggsave_hack(sprintf('%s/selected_capacities_by_customers.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
#   print(dist_of_cap_selected(df, scen_name, start_year, end_year, 'capacity'))
#   ggsave_hack(sprintf('%s/selected_capacities_by_capacity.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
#   print(dist_of_height_selected(df,scen_name,start_year))
#   ggsave_hack(sprintf('%s/selected_heights.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
# } else if(tech == 'solar'){
#   dist_of_azimuth_selected(df, start_year)
#   ggsave_hack(sprintf('%s/selected_azimuths.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
# }
```
# Supply Curves
...
# ggsave_hack(sprintf('%s/cf_supply_curve_by_sector.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
# elec_rate_supply_curve(df, start_year)
# ggsave_hack(sprintf('%s/elec_rate_supply_curve_by_sector.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
# make_npv_supply_curve(df, years = c(2014,2020,2030,2040,2050))
# ggsave_hack(sprintf('%s/npv_supply_curve.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
# make_npv_supply_curve_by_sector(df, years = 2014)
# ggsave_hack(sprintf('%s/npv_supply_curve_by_sector.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
# make_lcoe_supply_curve(df, years = c(2014,2020,2030,2040,2050))
# ggsave_hack(sprintf('%s/lcoe_supply_curve.png', ppt_dir), dpi = 600, height = 5, width = 8, units = 'in' )
```
